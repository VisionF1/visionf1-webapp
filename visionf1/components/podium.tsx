...
export function Podium({ drivers }: PodiumProps) {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-end min-h-[450px] mb-12 relative">
      ...
      <div className="flex items-end justify-center gap-4 md:gap-8 w-full max-w-4xl z-10 px-4">
